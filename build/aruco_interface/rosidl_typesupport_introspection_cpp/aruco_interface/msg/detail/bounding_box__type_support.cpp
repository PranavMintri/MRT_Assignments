...
{
  new (message_memory) aruco_interface::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_interface::msg::BoundingBox *>(message_memory);
...
void resize_function__BoundingBox__corners(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[1] = {
  {
    "corners",  // name
    ...
    offsetof(aruco_interface::msg::BoundingBox, corners),  // bytes offset in struct
    ...
    resize_function__BoundingBox__corners  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox_message_members = {
  ...
  1,  // number of fields
  sizeof(aruco_interface::msg::BoundingBox),
...
{
  return &::aruco_interface::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interface, msg, BoundingBox)() {
  return &::aruco_interface::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
